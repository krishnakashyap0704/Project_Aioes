...
export function AboutUs() {
    return (
        <>
            ...
            <br />
            <Container>
            <h1 className="text-center font-weight-bold mb-4 pagetitle">About Us</h1>
                <Alert variant="primary" style={{ marginTop: '20px', marginBottom: '30px', textAlign: 'center' }}>
                    <h3 style={{ fontWeight: 'bold' }}>Company Overview</h3>
                    <p>
                ...
                <Alert variant="primary" style={{ marginTop: '20px', marginBottom: '30px', textAlign: 'center' }}>
                    <h3 style={{ fontWeight: 'bold' }}>Mission & Vision</h3>
                    <p>
                ...
                <Container style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '20px', marginTop: '20px', marginBottom: '30px' }}>
                    <Row className="justify-content-md-center">
                        <h3 style={{ fontWeight: 'bold', textAlign: 'center' }}>Team Members</h3>
                        <Col lg={3}>
